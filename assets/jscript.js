/*------------------------------------------------------------------------
 # Lof K2 Slideshow Module for Jooml 3.0
 # ------------------------------------------------------------------------
 # author    LandOfCoder
...
if( typeof(LofSlideshow) == 'undefined' ){
  var LofSlideshow = new Class( {
    initialize:function( _lofmain, options ){
      ...
      this.minSize  = 0;
      this.onClick = false;
      if(Object.append(eMain) ){
        this.slides    = eMain.getElements( this.setting.mainItemSelector );
        this.maxWidth  = eMain.getStyle('width').toInt();
        this.maxHeight = eMain.getStyle('height').toInt();
        this.styleMode = this.__getStyleMode();  
        var fx =   Object.append({waiting:false, onComplete:function(){ this.onClick=false}.bind(this) }, this.setting.fxObject );
      ...
      if( Object.append(eNavigator) && Object.append(eNavOuter) ){
        var modes = {
        ...
        if( Object.append(_lofmain.getElement(".lof-bullets"))  ){
    ...
    setNavActive:function( index, item ){
      if( Object.append(this.navigatorItems) && Object.append( this.navigatorItems[index] ) ){ 
    ...
    registerButtonsControl:function( eventHandler, objects, isHover ){
      if( Object.append(objects) && this.slides.length > 1 ){
        for( var action in objects ){ 
          if( Object.append(this[action.toString()])  && Object.append(objects[action]) ){
