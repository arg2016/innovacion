...
<?php foreach ($slides as $slide) { ?>
        <div class="hoja" title="<?php echo $slide->title; ?>">
            ...
            <div class="titulo-nota">
                <h3><?php if ($params->get('show_title')) {
        echo $slide->title;
    } ?></h3>
            </div>
...
<script>
    jQuery(function () {
        jQuery("#mybook").booklet({width: "100%", auto:<?php echo $auto; ?>, tabs: !0, tabWidth: 180, tabHeight: 20, nextControlText: "Siguiente", previousControlText: "Anterior", height: 650})
    });
</script>